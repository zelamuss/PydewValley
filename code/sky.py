...
#Yağmur, güneş gibi doğal olayları oluşturmak için Sky sınıfını oluşturuyoruz.
class Sky:
	def __init__(self):
	...
	def display(self, dt): #Ekranda asıl gözükecek?
...
#Yağmur gibi olayların haritamıza gelme işlemleri
class Drop(Generic):
